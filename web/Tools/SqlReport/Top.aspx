<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Top.aspx.cs" Inherits="Tools_SQLReport_Top" %>
            ...
            <tr>
                ...
                <td background="../../IMAGES/top_bg.jpg">
                    <div style="width: 200px; text-align: right">
                        <span class="STYLE1">ERP报表平台</span></div>
                    <div style="text-align: right">
                        <span id="divToolBarForUsingHistory" visible="false" runat="server">
                            <asp:HyperLink ID="hyperLinkUsingHistory" runat="server" NavigateUrl="~/SQLReport/MainUsingHistory.aspx"
                                Target="mainFrame" ToolTip="报表使用情况统计" Text="报表使用情况统计界面" ForeColor="#FF8080" />&nbsp;&nbsp;&nbsp;&nbsp;
                        </span>
                        <span id="divToolBarForUserManage" visible="false" runat="server"><a href="mainManageUser.aspx"
                            target="mainFrame" title="用户管理 - ERP报表和辅助系统综合管理">进入用户管理界面</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        </span><span id="divToolBarForReportManage" visible="false" runat="server"><a href="mainManage.aspx"
                            target="mainFrame" title="报表管理"">进入报表管理界面</a>&nbsp;&nbsp;&nbsp;&nbsp; </span>
                        <a href="main.aspx" target="mainFrame" title="报表查看">进入报表查看平台</a>&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                </td>
            </tr>
        </table>
