<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HSF_List.aspx.cs" Inherits="HSF_List" %>
     ...
     <table width="100%" style="height:100%">
        <tr>
            <td style="width: 199px">
                发出日期：<asp:TextBox ID="Happen_Date_Start" runat="server" Text="" Width="113px" class="Wdate" onfocus="new WdatePicker(this,null,false,'whyGreen')"></asp:TextBox>&nbsp;</td>
                        ...
                        <igtbl:UltraGridBand>
                            ...
                            <Columns>
                                <igtbl:TemplatedColumn Width="30px">
                                    ...
                                    <CellTemplate>
                                        <a href="javascript:void(0)"  onclick="linkFrames('HSF_View.aspx?FID=<%= CurrentFactoryID.ToString() %>&did=<%#DataBinder.Eval(Container.DataItem,"rkey") %>&type=view')">查看</a>
                                    </CellTemplate>
                                ...
                                <igtbl:UltraGridColumn  BaseColumnName="Required_date" Width="80px">
                                ...
                                <igtbl:UltraGridColumn  BaseColumnName="from_comp" Width="60px">
                                    <Header Caption="发出单位">
                                ...
                                <igtbl:UltraGridColumn BaseColumnName="car_comp" Width="60px">
                                    <Header Caption="异常单位">
