<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyAction.aspx.cs" Inherits="MyAction" %>
     ...
     <table width="100%" style="height:100%">
        <tr>
            <td style="width: 68px; height: 12px;">
                录入日期：</td>
            <td style="width: 114px"><asp:TextBox ID="Date_Start" runat="server" Text="" Width="113px" class="Wdate" onfocus="new WdatePicker(this,null,false,'whyGreen')"></asp:TextBox>&nbsp;</td>
            <td style="width: 23px; height: 12px;">
                至</td>
            <td style="width: 131px"><asp:TextBox ID="Date_End" runat="server" Text="" Width="120px" class="Wdate" onfocus="new WdatePicker(this,null,false,'whyGreen')"></asp:TextBox>&nbsp;</td>
            <td style="width: 208px; height: 12px;"><asp:ImageButton ID="btn_search" ImageUrl="images/search.gif" runat="server" OnClick="btn_search_Click" />         </td>
            <td></td>
        </tr>
        <tr>
            <td colspan="8" style="vertical-align: top; text-align:left; height: 423px;">
                &nbsp;<igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="398px" Width="573px" OnInitializeRow="UltraWebGrid1_InitializeRow">
                    <Bands>
                        <igtbl:UltraGridBand>
                            ...
                            <Columns>
                                <igtbl:TemplatedColumn Width="30px">
                                    ...
                                    <CellTemplate>
                                        <a href="javascript:void(0)" onclick="linkFrames('<%#DataBinder.Eval(Container.DataItem,"linkName") %>_new.aspx?FID=<%= CurrentFactoryID.ToString() %>&did=<%#DataBinder.Eval(Container.DataItem,"rkey") %>&type=view')">查看</a>
                                    </CellTemplate>
