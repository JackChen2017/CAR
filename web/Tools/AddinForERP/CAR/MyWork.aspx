...
<body>
    ...
    <div class="top">我的已发启信息</div>     
     <div><hr /></div>
     <table style=" width:100%; height:100%">
        <tr>
            <td style="width: 66px; height: 12px;">
                录入日期：</td>
            <td style="width: 118px"><asp:TextBox ID="Date_Start" runat="server" Text="" Width="113px" class="Wdate" onfocus="new WdatePicker(this,null,false,'whyGreen')"></asp:TextBox>&nbsp;</td>
            ...
            <td style="width: 270px; height: 12px;"><asp:ImageButton ID="btn_search" ImageUrl="images/search.gif" runat="server" OnClick="btn_search_Click" />         </td>
            <td></td>
        </tr>
        <tr>
            <td colspan="6" style="vertical-align: top; text-align:left; height: 390;">
                &nbsp;<igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="394px" Width="626px" OnInitializeRow="UltraWebGrid1_InitializeRow">
                    <Bands>
                        <igtbl:UltraGridBand>
                            ...
                            <Columns>
                                <igtbl:TemplatedColumn Width="30px">
                                    ...
                                    <CellTemplate>
                                        <a href="javascript:void(0)" onclick="linkFrames('<%#DataBinder.Eval(Container.DataItem,"linkName") %>_view.aspx?FID=<%= CurrentFactoryID.ToString() %>&did=<%#DataBinder.Eval(Container.DataItem,"rkey") %>&type=view')">查看</a>
                                    </CellTemplate>
                                ...
                                <igtbl:TemplatedColumn Width="50px">
                                    ...
                                    <CellTemplate>
                                        <a href="javascript:void(0)" onclick="Show('ApprovalDetail.aspx?type=<%# Eval("linkName") %>&FID=<%= CurrentFactoryID.ToString() %>&did=<%# Eval("rkey") %>')">点击查看</a>
                                    </CellTemplate>
                                    <Footer>
                                        <RowLayoutColumnInfo OriginX="8" />
                                    </Footer>
                    ...
                    <DisplayLayout AutoGenerateColumns="False" AllowColSizingDefault="Free" AllowSortingDefault="OnClient" BorderCollapseDefault="Separate"
                        ...
                        <FrameStyle BackColor="Window" BorderColor="InactiveCaption" BorderStyle="Solid"
                            BorderWidth="1px" Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Height="394px"
                            Width="626px">
                        </FrameStyle>
