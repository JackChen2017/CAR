...
public partial class MyAction : FounderTecInfoSys.Common.PageBase.DomainMasterPage 
{
...
//                    where status in (0,14)";
//        if (issued_Date_Start.Text != "")
//        {
//            sql += " and datediff(d,issued_date,'" + issued_Date_Start.Text + "') <= 0 ";
//        }
//        if (issued_Date_End.Text != "")
//        {
//            sql += " and datediff(d,issued_date,'" + issued_Date_End.Text + "') >= 0 ";
//        }
//        if (!CurrentUser.RightIsAdmin)
//        {
//            sql += " and nowuser = '" + CurrentUser.UserADAcount + "'";
//        }
