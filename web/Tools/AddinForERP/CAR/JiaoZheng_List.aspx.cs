...
public partial class JiaoZheng_List :  FounderTecInfoSys.Common.PageBase.DomainMasterPage 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!HasRight(XmlSource.GetRightIndex("JIAOZHENG")) || !HasRight(XmlSource.GetRightIndex("VIEW")))
            {
    ...
    {
        string sql = @"select rkey,Serial_No,convert(char(10),Happen_Date,20) as Happen_Date,HSF_Happen_Type,
                    convert(char(10),required_date,20) as required_date,from_comp,car_comp,car_part_num,status from CAR_Table_Data01 where op_type=3 ";
    ...
    protected void UltraWebGrid1_InitializeRow(object sender, Infragistics.WebUI.UltraWebGrid.RowEventArgs e)
    {
        ...
        {
            case "1": e.Row.Cells[8].Value = "矫正措施"; break;
            case "2": e.Row.Cells[8].Value = "预防措施"; break;
