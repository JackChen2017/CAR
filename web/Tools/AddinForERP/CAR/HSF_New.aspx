<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeFile="HSF_New.aspx.cs" EnableEventValidation="false" Inherits="HSF" %>
...
//        }
    ...
    function ChechData()
    {
        if($["HSF_Happen_Type_1"].checked == false && $["HSF_Happen_Type_2"].checked == false && $["HSF_Happen_Type_3"].checked == false && $["HSF_Happen_Type_4"].checked == false && $["HSF_Happen_Type_5"].checked == false)
        {
            alert('请选择异常发生类别');
...
<body>
 ...
 <td style="color: #3399ff" class="top">
     <asp:Image ID="Image1" runat="server" ImageUrl="images/icon_editobject.gif" />新建HSF异常处理通知单</td>  
   </tr>
  </table>
...
<tr><td colspan="4" class="FieldTop" >基本信息</td></tr>
    ...
    <tr>
     ...
     异常发生类别</td>
        <td class="FieldText" colspan="1">
            <asp:CheckBox ID="HSF_Happen_Type_1" runat="server"  Text="制品" onclick="ChangeCheck(this)" Font-Size="12px" />&nbsp;&nbsp;
            <asp:CheckBox ID="HSF_Happen_Type_2" runat="server" Text="制程"  onclick="ChangeCheck(this)" Font-Size="12px"/>&nbsp;&nbsp;
            <asp:CheckBox ID="HSF_Happen_Type_3" runat="server"  Text="外包" onclick="ChangeCheck(this)" Font-Size="12px"/>&nbsp;&nbsp;
            <asp:CheckBox ID="HSF_Happen_Type_4" runat="server"  Text="原物料" onclick="ChangeCheck(this)" Font-Size="12px" />&nbsp;&nbsp;
            <asp:CheckBox ID="HSF_Happen_Type_5" runat="server" Text="其他" onclick="ChangeCheck(this)" Font-Size="12px"/></td>
        <td class="FieldTitle" style="height: 20px;font-size:12px">
            编号:</td>
        <td class="FieldText"  colspan="1">
        <asp:TextBox ID="Serial_No" runat="server" Text="HSF" ReadOnly="true"></asp:TextBox>
         </td>
    </tr>
    <tr>
        <td class="FieldTitle" style="height: 20px;font-size:12px">
...
<table cellspacing="0" cellpadding="0" width="100%" class="TbsWhl">
  ...
  <asp:ImageButton ID="sendApproval" runat="server" ImageUrl="Images/button-send.gif" OnClick="sendApproval_Click" OnClientClick="ChechData()" />
    <asp:ImageButton ID="ibtn_Save" runat="server" ImageUrl="Images/button-save.gif" OnClick="ibtn_Save_Click"   OnClientClick="ChechData()" />&nbsp;</td>
