<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="8D_New.aspx.cs" Inherits="_8D" %>
        ...
        <table width="100%">
            <tr>
                <td style="color: #3399ff" class="top">
                    <asp:Image ID="Image1" runat="server" ImageUrl="images/icon_editobject.gif" />新建（8D）CORRECTIVE ACTION REPORT 界面
                </td>  
            </tr>
        </table>
        <table cellspacing="0" cellpadding="0" width="100%" class="TbsWhl">
            <tr>
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" class="TbsWhl">
                        <tr>
                            <td colspan="4" class="FieldTop" >基本信息</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="FieldTitle" style="font-size:12px" >问题描述：</td>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%" class="TbsWhl">
                        <tr>
                            ...
                            <td align="left" style="height: 24px">
                                ...
                                <asp:ImageButton ID="ibtn_Cancel" runat="server" ImageUrl="Images/button-cancel.gif" OnClientClick="CheckData()"  />&nbsp;
                            </td>
                        </tr>
                    </table>
                </td>
