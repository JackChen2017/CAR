<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MainManage.aspx.cs" Inherits="Tools_SQLReport_MainManage" %>
...
document.write('<frame name="leftFrame" border="0" frameborder="0" marginheight="0" marginwidth="0" target="masterFrame" style="BORDER-RIGHT: #99ccff 1px solid; BORDER-TOP: #003366 1px solid" leftmargin="0" topmargin="0" scrolling="YES" noresize src="Left.aspx?Type=2" >');
document.write('<frame name="masterFrame" src="InputAddinForm.aspx" scrolling="YES" border="0" bordercolor="#6699cc" frameborder="no" style="BORDER-LEFT: #99ccff 2px groove; BORDER-TOP: #003366 1px solid">');
